...
public static class Assertion
{
  ...
  public static SimpleAssert IsProperty(this SimpleAssert sa)
  {
    ...
    if (member != null)
    {
      ...
      sa.FromPreviousAssertion = sa.Value.GetType().GetProperty(member.Name, BindingFlags.Instance | BindingFlags.NonPublic);
    }
    else
    {
  ...
  public static SimpleAssert IsField(this SimpleAssert sa)
  {
    ...
    if (member != null)
    {
      ...
      sa.FromPreviousAssertion = sa.Value.GetType().GetField(member.Name, BindingFlags.Instance | BindingFlags.NonPublic);
    }
    else
    {
      if (sa.Value.GetType().MemberType != MemberTypes.Field)
